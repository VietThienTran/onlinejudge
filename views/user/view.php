...
<div class="user-view">
    ...
    <?php if ($model->role != \app\models\User::ROLE_PLAYER): ?>
        <div class="row">
            <div class="col-md-3">
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        'nickname',
                        [
                            'attribute' => Yii::t('app', 'Zalo account'),
            ...
            <div class="col-md-9">
                ...
                <div id="placeholder" style="width:100%;height:300px;"></div>
                    <hr>
                <?php endif; ?>
                <p><?=Yii::t('app','Recent Submissions')?></p>
        ...
        <hr>
        <h3><?=Yii::t('app','Problem Solved')?> <small>(<?= count($solutionStats['solved_problem']) ?>)</small></h3>
        <ul>
        ...
        <hr>
        <h3><?=Yii::t('app','Problem Unsolved')?> <small>(<?= count($solutionStats['unsolved_problem']) ?>)</small></h3>
        <ul>
        ...
        <div class="row">
            <div class="left-list col-md-6">
                <ul class="stat-list">
                    <li>
                        <strong><?=Yii::t('app','Total Submission')?>: </strong><span> <?= $solutionStats['all_count'] ?></span>
                    </li>
                    <li>
                        <strong><?=Yii::t('app','Total Accepted')?>: </strong><span> <?= $solutionStats['ac_count'] ?></span>
                    </li>
                    <li>
                        <strong><?=Yii::t('app','Accepted Rate')?>: </strong>
                        <span>
            ...
            <div class="right-list col-md-6">
                <ul class="stat-list">
                    <li>
                        <strong><?=Yii::t('app','Wrong Answer')?>: </strong><span> <?= $solutionStats['wa_count'] ?></span>
                    </li>
                    <li>
                        <strong><?=Yii::t('app','Time Limit Exceeded')?>: </strong><span> <?= $solutionStats['tle_count'] ?></span>
                    </li>
                    <li>
                        <strong><?=Yii::t('app','Compile Error')?>: </strong><span> <?= $solutionStats['ce_count'] ?></span>
                    </li>
                </ul>
            </div>
        </div>
