...
<div class="row">
    ...
    <div class="col-md-4 problem-info">
        ...
        <?= Html::a('<span class="glyphicon glyphicon-arrow-left"></span> '.Yii::t('app','Prev'),
            $previousProblemID ? ['/problem/view', 'id' => $previousProblemID, 'view' => 'classic'] : 'javascript:void(0);',
            ['class' => 'btn btn-default', 'style' => 'width: 30%', 'disabled' => !$previousProblemID]
        )?>

        <?= Html::a(Yii::t('app','Next').' <span class="glyphicon glyphicon-arrow-right"></span>',
            $nextProblemID ? ['/problem/view', 'id' => $nextProblemID, 'view' => 'classic'] : 'javascript:void(0);',
            ['class' => 'btn btn-default', 'style' => 'width: 30%', 'disabled' => !$nextProblemID]
        )?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?= Html::a('<span class="glyphicon glyphicon-edit"></span>',
                                ['/solution/source', 'id' => $sub['id']],
                                ['title' => Yii::t('app','View Source Code'), 'onclick' => 'return false', 'data-click' => "solution_info", 'data-pjax' => 0]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
