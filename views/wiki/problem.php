...
?>
<blockquote>
    Một chủ đề hay, một trò chơi hay sẽ tuân theo những quy luật nhất định. Để chuẩn hóa hình thức câu hỏi, các quy tắc này được xây dựng đặc biệt.
</blockquote>
<h3>nội dung chủ đề</h3>
<p>
    Chủ đề nên bao gồm: tiêu đề, mô tả, mô tả đầu vào, mô tả đầu ra, đầu vào mẫu, đầu ra mẫu, giải thích mẫu hoặc thông tin nhắc nhở (tùy chọn), dữ liệu kiểm tra.
</p>
<p>
    Nếu cần thiết, bạn nên viết bạo lực và sử dụng bạo lực cho phù hợp với tiêu chuẩn.
</p>

<h3>Yêu cầu về tệp dữ liệu kiểm tra cho câu hỏi</h3>
<ol>
    <li>Tệp dữ liệu chứa các tệp đầu vào, các tệp đầu ra. Ngay cả khi không có yêu cầu đầu vào cho tiêu đề, vẫn phải bao gồm một tệp đầu vào trống (Lưu ý: Không thể tải lên tệp trống do thành phần tải lên. Nếu không có yêu cầu đầu vào, bạn cần nhập một vài khoảng trắng vào chỗ trống tập tin để tải tập tin lên).</li>
